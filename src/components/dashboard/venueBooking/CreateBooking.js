                    ...
                    <div className="col-md-8 col-xs-8" style={{paddingBottom:"23px"}}>
                         ...
                         <DatePicker
                            ...
                            onChange={date => {
                                ...
                                const dateComponent = dateStart.utc().format('YYYY-MM-DD');
                                const timeComponent = dateStart.utc().format('HH:mm:ss');
                               const finalDateStart = dateComponent +"T" +timeComponent+"+00:00";

                                setStart(finalDateStart);
                            }}
                        />
                    ...
                    <div className="col-md-8 col-xs-8" style={{paddingBottom:"23px"}}>
                         ...
                         <DatePicker
                            ...
                            onChange={date => {
                                ...
                                var dateComponent = datemovement.utc().format('YYYY-MM-DD');
                                var timeComponent = datemovement.utc().format('HH:mm:ss');
                               const finalDate = dateComponent +"T" +timeComponent+"+00:00";
