...
const ViewVenue = function ViewVenue(props) {
    ...
    return (
        ...
        <div className="row show-user-heading">
            ...
            <div className="col-md-2">
                   <button className="button button-full" style={{marginLeft:"unset"}} onClick={event => {
                        onBack();
                ...
                <h4 className="user-name-heading-4" style={{fontWeight: "bold", fontSize: "24px", lineHeight: "30px"}}>{venueData.name}</h4>
              </div>
              <div className="col-md-2">
                   {/* <button className="button button-full button-delete" onClick={event => {
                       onDelete(event);
                    }}>Delete</button> */}
                    <button className="cancel-button" style={{marginTop:"unset", marginRight:"unset"}}  onClick={event => {
                       onDelete(event);
                    }}>
                <b>
